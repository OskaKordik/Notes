...
class LoginUseCaseImpl(private val repository : MockLoginRepository, private val authPrefs: AuthPrefs): LoginUseCase{
    override suspend fun execute(email: String, password: String,onComplete: (com.natife.streaming.utils.Result<Unit>) -> Unit) {
