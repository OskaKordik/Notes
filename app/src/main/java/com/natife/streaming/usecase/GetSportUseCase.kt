...
class GetSportUseCaseImpl(private val api: MainApi, private val prefs: SettingsPrefs): GetSportUseCase{
    ...
    override suspend fun execute(reload:Boolean): List<Sport> {
        ...
        if (catche == null || reload ){
            ...
            val translates = api.getTranslate(BaseRequest(procedure = API_TRANSLATE,params = TranslateRequest(
